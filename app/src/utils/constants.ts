...
const BACKEND_URL = 'https://tuzinhorisonho.pythonanywhere.com';
...
export const REACTION_OPTIONS = [
  ...
  { code: ReactionType.PRAY, emoji: '🙏', label: 'Força' },
];

export const OTHER_VALUE = '__other__';

export const VITAL_KIND_CHOICES = [
  'Pressão arterial (PA)', 'Frequência cardíaca (FrC)', 'SpO2 (Oxímetro)', 'Temperatura', OTHER_VALUE,
];

export const VITAL_STATUS_CHOICES = [
  'Normal', 'Hipertenso', 'Hipotenso', 'Febre',
  'Hipotermia', 'Taquicardia', 'Bradicardia', 'Baixa saturação', OTHER_VALUE,
];

export const BATHROOM_TYPE_CHOICES = [
  'Urina', 'Evacuação', 'Banho', 'Vômito', 'Higienização oral', OTHER_VALUE,
];

export const MEAL_TYPE_CHOICES = [
  'Café da manhã', 'Lanche da manhã', 'Almoço', 'Lanche da tarde', 'Jantar', 'Ceia da noite', OTHER_VALUE,
];

export const MEAL_ACCEPTANCE_CHOICES = ['Boa aceitação', 'Ruim aceitação', OTHER_VALUE];

export const SLEEP_EVENT_CHOICES = ['dormiu', 'acordou', OTHER_VALUE];

export const PROGRESS_TREND_CHOICES = ['evolution', 'regression', OTHER_VALUE];
